...
public class Values {
	...
	public static final Value.UnknownObjectValue OBJECT_VALUE = new Value.UnknownObjectValue(Types.instanceType(Object.class));
	public static final Value.UnknownObjectValue STRING_VALUE = new Value.UnknownObjectValue(Types.instanceType(String.class));
	...
	public static @NotNull Value.PrimitiveValue valueOfPrimitive(@NotNull PrimitiveType primitiveType) {
		return switch (primitiveType.kind()) {
			case PrimitiveKind.T_BOOLEAN,
					PrimitiveKind.T_BYTE,
					PrimitiveKind.T_CHAR,
					PrimitiveKind.T_SHORT,
					PrimitiveKind.T_INT -> INT_VALUE;
