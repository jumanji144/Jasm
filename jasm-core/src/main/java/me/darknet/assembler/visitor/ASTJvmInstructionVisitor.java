...
public interface ASTJvmInstructionVisitor extends ASTInstructionVisitor {
	 ...
	 *
	 * @param operand the operand, is an integer, with no decimal point
	 */
	 ...
	 *
	 * @param type the operand, is one of the following: boolean, char, float, double, byte, short, int, long
	 */
	 ...
	 *
	 * @param var the variable name to load, this can either be a local or a parameter. Note that the variable name
	 *            does not correspond to a unique index, but rather to the name of the variable.
	 */
	 ...
	 *
	 * @param var       the variable name to increment.
	 ...
	 *
	 * @param lookupSwitchObject an object structured like the following:
	 *                           <pre>
	 *                           { <br>
	 *                              default: label <br>
	 *                              number: label <br>
	 ...
	 *                              ... <br>
	 *                           }
	 *                           </pre> number elements correspond to ASTNumber, label elements correspond to ASTIdentifier
	 */
	 ...
	 *
	 * @param tableSwitchObject an object structured like the following:
	 *                          <pre>
	 *                          { <br>
	 *                             min: number <br>
	 *                             max: number <br>
	 ...
	 *                             default: label <br>
	 *                          }
	 *                          </pre> number correspond to ASTNumber, [ ] correspond to ASTArray, label elements correspond to ASTIdentifier
	 */
	 ...
	 * @note the existence of `invokexinterface`, which corresponds to the `itf` flag on the instruction being `true`
	 */
	 ...
	 * @param name       the name of the method
	 * @param descriptor the descriptor of the method
	 * @param bsm        the bootstrap method, see {@link me.darknet.assembler.helper.Handle#from(ASTArray)}
